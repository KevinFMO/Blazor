...
namespace Blazor.Pages.MisUsuarios
{
    partial class NuevoUsuario
    {
        ...
        [Inject] private SweetAlertService swalt { get; set; }
        ...
        protected async void Guardar()
        {
            ...
            if (inserto)
            {
                await swalt.FireAsync("Guardar", "Usuario Guardado con exito", SweetAlertIcon.Success);
            }
            else
            {
                await swalt.FireAsync("Error", "No se pudo guardar el usuario", SweetAlertIcon.Error);
            }
